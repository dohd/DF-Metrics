...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('reports.attendance_summary') }}">Attendance Summary</a></li>
      </ol>
    </nav>
</div>
...
<div class="card mb-3">
    <div class="card-body">
        ...
        <div class="card-content p-2">
            {{ Form::open(['route' => 'reports.attendance_summary.post', 'method' => 'POST', 'target' => '_blank']) }}
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-12">
                        {{ Form::date('date_from', date('Y-01-01'), ['class' => 'form-control', 'required' => 'required']) }}
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="date" class="col-md-2">To Date</label>
                    <div class="col-md-6 col-12">
                        {{ Form::date('date_to', date('Y-12-31'), ['class' => 'form-control', 'required' => 'required']) }}
                    </div>
                </div>                
