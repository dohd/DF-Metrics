...
@section('title', 'Team Member Summary')

@section('content')
<div class="pagetitle">
    <div class="row">
      <div class="col-6">
        <h1>Team Member Summary</h1>
      </div>
    </div>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
        <li class="breadcrumb-item active"><a href="{{ route('assign_scores.index') }}">Team Member Summary</a></li>
      </ol>
    </nav>
</div>
...
<div class="card mb-3">
    <div class="card-body">
        <h5 class="card-title mb-0">Team Member Summary</h5>
